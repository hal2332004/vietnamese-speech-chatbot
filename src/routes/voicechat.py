...
import os
from src.services.STT.stt_module import transcribe_audio
from src.services.TTT.ttt_module import generate_answer
from src.services.TTS.tts_module import tts_generate
import warnings
...
async def voice_chat(file: UploadFile):
    ...
    tts_generate(answer, f"temp/tts_{file.filename}")
